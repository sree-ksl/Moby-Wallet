...
public class VotingActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        VotingAdapter votingAdapter = new VotingAdapter(getApplicationContext(), address1List);
        addressListView.setAdapter(votingAdapter);
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        Toast.makeText(VotingActivity.this, "Voted ", Toast.LENGTH_SHORT).show();
        Intent account = new Intent(VotingActivity.this, AccountActivity.class);
